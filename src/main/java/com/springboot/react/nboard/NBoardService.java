...
public class NBoardService {
	...
	public NBoardVO selectById(NBoardVO vo) {
		return nboardDAO.selectById(vo);
	}
	...
	@Transactional
	public void update(NBoardVO vo, String Btitle, String Btext) {
		NBoardVO selected = nboardDAO.selectById(vo);
	...
	public void delete(NBoardVO vo) {
		NBoardVO selected = nboardDAO.selectById(vo);
		nboardDAO.delete(selected);
	}
	
	
   public List<NBoardVO> getList(NBoardVO vo){
	      return nboardDAO.getList(vo);
   }
